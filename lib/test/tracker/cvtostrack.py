...
class CVTOSTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(CVTOSTrack, self).__init__(params)
        network = build_cvtostrack(params.cfg, training=False)
    ...
    def track(self, image, info: dict = None):
        ...
        if out_dict['score_map'].max().item()>=0.8:
            self.search_factor = 4
        #

...
def build_roistrack(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('ROISTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'ROISTrack' in cfg.MODEL.PRETRAIN_FILE and training:

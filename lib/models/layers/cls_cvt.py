...
class ConvolutionalVisionTransformer(nn.Module):
    ...
    def forward(self, z, x):
        zx = self.forward_features(z, x)
        #z = self.head(z)
        return zx


@register_model
def get_cls_model(pretrained=None, config=None , **kwargs):
    ...
    if config.MODEL.INIT_WEIGHTS and pretrained is not None:
        msvit.init_weights(
            pretrained,

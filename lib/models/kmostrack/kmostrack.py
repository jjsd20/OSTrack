...
def build_kmostrack(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('KMOSTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'KMOSTrack' in cfg.MODEL.PRETRAIN_FILE and training:

...
# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = 'CvT-13-384x384-IN-22k.pth'

cfg.MODEL.PRETRAINED = 'CvT-13-384x384-IN-22k.pth'
cfg.MODEL.PRETRAINED_LAYERS = ['*']
cfg.MODEL.INIT_WEIGHTS = True
cfg.MODEL.VERBOSE = True  # 移动了 VERBOSE 到 cfg.MODEL 下
...
cfg.MODEL.BACKBONE.TYPE = "ConvolutionalVisionTransformer"
...
# MODEL.SPEC
cfg.MODEL.SPEC = edict()
cfg.MODEL.SPEC.NUM_STAGES = 3
cfg.MODEL.SPEC.PATCH_SIZE = [7, 3, 3]
cfg.MODEL.SPEC.PATCH_STRIDE = [4, 2, 2]
cfg.MODEL.SPEC.PATCH_PADDING = [2, 1, 1]
cfg.MODEL.SPEC.DIM_EMBED = [64, 192, 384]
cfg.MODEL.SPEC.NUM_HEADS = [1, 3, 6]
cfg.MODEL.SPEC.DEPTH = [1, 2, 10]
cfg.MODEL.SPEC.MLP_RATIO = [4.0, 4.0, 4.0]
cfg.MODEL.SPEC.ATTN_DROP_RATE = [0.0, 0.0, 0.0]
cfg.MODEL.SPEC.DROP_RATE = [0.0, 0.0, 0.0]
cfg.MODEL.SPEC.DROP_PATH_RATE = [0.0, 0.0, 0.1]
cfg.MODEL.SPEC.QKV_BIAS = [True, True, True]
cfg.MODEL.SPEC.CLS_TOKEN = [False, False, False]
cfg.MODEL.SPEC.POS_EMBED = [False, False, False]
cfg.MODEL.SPEC.QKV_PROJ_METHOD = ['dw_bn', 'dw_bn', 'dw_bn']
cfg.MODEL.SPEC.KERNEL_QKV = [3, 3, 3]
cfg.MODEL.SPEC.PADDING_KV = [1, 1, 1]
cfg.MODEL.SPEC.STRIDE_KV = [2, 2, 2]
cfg.MODEL.SPEC.PADDING_Q = [1, 1, 1]
cfg.MODEL.SPEC.STRIDE_Q = [1, 1, 1]
cfg.MODEL.SPEC.INIT = 'trunc_norm'

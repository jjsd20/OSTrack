...
cfg.TRAIN.TIMESNET_L1_WEIGHT = 0.5
cfg.TRAIN.TIMESNET_GIOU_WEIGHT = 0.2
...
cfg.TIMING.d_ff = 64,  # Feed-forward dimension
cfg.TIMING.e_layers = 3,  # Number of TimesBlock layers
cfg.TIMING.top_k = 3,  # Number of top frequencies
cfg.TIMING.num_kernels = 6,  # Number of convolution kernels
cfg.TIMING.embed = 'timeF',  # Embedding type
cfg.TIMING.freq = 'h',  # Frequency
